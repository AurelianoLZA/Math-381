        ...
        #         players.append(1)
            ...
            while(cardIndex<24):
                ...
                if (currentPlayer in [0]):
                    ...
                    gap = ((currentCard+2 in players[currentPlayer].cards) and (currentCard+2 not in known)) or ((currentCard -2 in players[currentPlayer].cards) and (currentCard -2 not in known))
