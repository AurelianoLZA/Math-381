        ...
        #         players.append(1)
            ...
            while(cardIndex<24):
                ...
                if (currentPlayer in [0]):
                    players[currentPlayer].tokens, players[currentPlayer].cards, cardIndex, currentTokens, known = strat2.strat2(
                        currentCard,players,currentPlayer,currentTokens,cardIndex,known
                    )
